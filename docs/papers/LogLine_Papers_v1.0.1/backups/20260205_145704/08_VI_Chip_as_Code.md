...
|-------|------------------|---------------------|
| **A** — Ethics is Efficient | Ética reduz custo total | Safeguards não são overhead |
| **B** — Hardware as Text | Texto é o substrato do poder | Policy compila, não "aconselha" |
...
Papers A, B, I–VI juntos formam um protocolo completo e implementável para accountability verificável.
